...
public class ItemManager {
    ...
    public ItemStack getInstantTNT() {
        return instantTNT;
    }
    ...
    public ItemStack getEndBuff() {
        return endBuff;
    }

    public ItemStack getTNTLaunch() {
        return TNTLaunch;
    }

    public SpecialItem getCompassItem() {
        return compassItem;
    }

    public SpecialItem getInstantTNTItem() {
        return instantTNTItem;
    }

    public SpecialItem getSoupItem() {
        return soupItem;
    }

    public SpecialItem getEndBuffItem() {
        return endBuffItem;
    }

    public SpecialItem getTNTLaunchItem() {
        return TNTLaunchItem;
    }
    ...
    public InjectionSpecialItems getIsi() {
        return isi;
    }
}
