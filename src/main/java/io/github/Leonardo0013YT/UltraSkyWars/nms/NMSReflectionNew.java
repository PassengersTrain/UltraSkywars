...
public class NMSReflectionNew extends NMSReflection {
    ...
    public void sendPacket(Player player, Object packet) {
        try {
            ...
            cp.b((net.minecraft.server.v1_8_R3.Entity) packet);
    ...
    public void moveDragon(Entity ent, double x, double y, double z, float yaw, float pitch) {
        ...
        try {
            if (ent instanceof EnderDragon) {
                // Moving the EnderDragon entity
                EnderDragon dragon = (EnderDragon) ent;
                ((net.minecraft.server.v1_8_R3.EntityEnderDragon) getHandleEntity.invoke(dragon)).setPositionRotation(x, y, z, yaw, pitch);
            }
